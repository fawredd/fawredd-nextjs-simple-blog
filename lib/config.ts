...
export const SITE_NAME = `Bioregen Lab`;
export const SITE_URL = `https://bioregen-lab.vercell.app`;
export const SITE_DESCRIPTION =
  "Líderes en medicina regenerativa y terapias avanzadas.";

export const brand = `Bioregen Lab`;
export const blogIntro = `Explora los últimos avances y noticias en medicina regenerativa. El blog de Bioregen Lab te mantiene informado sobre terapias celulares, tratamientos innovadores y el futuro de la salud.`;
...
export const mainSpecialities = [
  ...
  {
    title: "ESTÉTICA",
    description: `Resultados naturales y personalizados: Cada tratamiento se adapta a tus necesidades específicas, logrando un aspecto más joven y saludable.
...
export const specialties = [
  {
    title: "TRAUMATOLOGÍA",
    description:
      "Solo determinados tejidos y órganos son capaces de regenerarse espontáneamente después de una enfermedad o trauma. Esta capacidad humana explora enfoques terapéuticos regenerativos para tratar diversas afecciones.",
    applications: [
      "Lesiones deportivas",
      "Fracturas complejas",
  ...
  },
  {
    title: "NEUROLOGÍA",
    description:
      "La medicina regenerativa neurológica se enfoca en la restauración de la función del sistema nervioso mediante terapias celulares avanzadas y factores de crecimiento específicos.",
    applications: [
  ...
  },
  {
    title: "ODONTOLOGÍA",
    description:
      "Aplicación de terapias regenerativas en odontología para la restauración de tejidos dentales, periodontales y maxilofaciales.",
    applications: [
  ...
  },
  {
    title: "ESTÉTICA",
    description:
      "Medicina estética regenerativa que utiliza factores de crecimiento para rejuvenecimiento facial y corporal.",
    applications: [
